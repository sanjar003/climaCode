let rotateDiv = document.getElementById("rot");
let rotateIcons = document.getElementById("rot-icons");
let clickRotateDiv = document.getElementById("click-rot");
let angle = 0;
...
let color2 = "rgba(0,0,0,0.1)";

let gradient = " conic-gradient(";
for (let i = 0; i < 360; i += step) {
  let color = i % (2 * step) === 0 ? color1 : color2;
